...
const CTAbutton: React.FC<CTAbuttonProps> = ({
  ...
  return (
    <Link
      href={href}
      className={`group block relative h-[50px] w-full max-w-[150px] overflow-hidden rounded-[7px] border flex justify-center items-center text-center text-[16px] transition-all delay-500 duration-400 ease-in ${bgColor} ${borderColor} ${textColor} ${hoverTextColor} `}
    >
      {/* Top SVG */}
