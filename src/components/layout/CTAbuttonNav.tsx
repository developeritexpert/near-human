...
export default function CTAbuttonNav({ href, text }: CTAbuttonProps) {
  return (
    <Link
      href={href}
      className="group relative block flex h-[40.5px] w-full max-w-[120.7px] items-center justify-center overflow-hidden rounded-[7px] bg-white px-[2rem] py-[0.75rem] text-black transition-colors duration-300 hover:text-white hover:underline"
    >
